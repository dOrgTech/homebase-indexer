...
async def on_propose(
    ...
    proposer = await models.Holder.get(address=proposal_diff['value']['proposer'])
    ...
    await models.Proposal.get_or_create(
        dao=dao,
        ...
        defaults={
            ...
            'quorum_threshold': proposal_diff['value']['quorum_threshold'],
